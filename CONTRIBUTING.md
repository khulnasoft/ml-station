...
> _Please refer to the [documentation of ml-buildkit](https://github.com/khulnasoft/ml-buildkit#automated-build-pipeline-ci) for instructions on how to execute the build-scripts directly on your machine instead of using the containerized approach documented below._
