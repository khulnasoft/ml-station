...
RUN \
    ...
    cp -f $RESOURCES_PATH/branding/ml-station-logo.svg $RESOURCES_PATH"/filebrowser/img/logo.svg"
...
LABEL \
    ...
    "org.opencontainers.image.documentation"="https://github.com/khulnasoft/ml-station" \
    "org.opencontainers.image.url"="https://github.com/khulnasoft/ml-station" \
