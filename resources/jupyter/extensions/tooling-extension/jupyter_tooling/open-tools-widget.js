define([
  ...
  function sshInstructionDialog(setup_command) {
    ...
    var div = $("<div/>");
    div.append(
      '<p>SSH provides a powerful set of features that enables you to be more productive with your development tasks as documented <a target="_blank" href="https://github.com/khulnasoft/ml-station#ssh-access">here</a>. To setup a secure and passwordless SSH connection to this workspace, please execute: </p>'
    );
    div.append("<br>");
    div.append(
  ...
  //github.com/khulnasoft/ml-station#ssh-access
  https: function load_ipython_extension() {
    ...
    components.getToolingList(function (tools) {
      ...
      docs_button = '<form action="https://github.com/khulnasoft/ml-station#features"  target="_blank" style="display: inline-block;margin-left: 2px;"><button class="btn btn-default btn-sm"> <i class="fa-github fa"></i> Docs</button></form>'
      ...
      tools_dropwdown =
        ...
        '<li><div style="display: block;padding: 3px 20px;clear: both;font-weight: 400;line-height: 1.42857143;color: #333333;white-space: nowrap;"><div>Do you like ML Workspace?</div><span style="display: block; color: #gray; padding: initial; font-size: 12px;"><a href="https://github.com/khulnasoft/ml-station" style="color: #333333;font-weight: 550;" target="_blank">Give us a star</a> or <a href="https://twitter.com/khulnasoft" style="color: #333333;font-weight: 550;" target="_blank">follow us on Twitter!</a></span></div></li>' +
        " </ul> </div>";        
