...
<p align="center">
    <a href="https://hub.docker.com/r/khulnasoft/ml-station" title="Docker Image Version"><img src="https://img.shields.io/docker/v/khulnasoft/ml-station?color=blue&sort=semver"></a>
    <a href="https://hub.docker.com/r/khulnasoft/ml-station" title="Docker Pulls"><img src="https://img.shields.io/docker/pulls/khulnasoft/ml-station.svg?color=blue"></a>
    <a href="https://hub.docker.com/r/khulnasoft/ml-station" title="Docker Image Size"><img src="https://img.shields.io/docker/image-size/khulnasoft/ml-station?color=blue&sort=semver"></a>
...
<p align="center">
  ...
  <a href="https://github.com/khulnasoft/ml-station/issues/new?labels=bug&template=01_bug-report.md">Report a Bug</a> •
  <a href="#faq">FAQ</a> •
...
```bash
docker run -p 8080:8080 khulnasoft/ml-station:0.13.2
```
...
```bash
docker run -p 8080:8080 --env AUTHENTICATE_VIA_JUPYTER="mytoken" khulnasoft/ml-station:0.13.2
```
...
```bash
docker run -p 8080:8080 --env WORKSPACE_AUTH_USER="user" --env WORKSPACE_AUTH_PASSWORD="pwd" khulnasoft/ml-station:0.13.2
```
...
```bash
docker run -p 8080:8080 --cpus=8 --memory=16g --shm-size=1G khulnasoft/ml-station:0.13.2
```
...
In addition to the main workspace image (`khulnasoft/ml-station`), we provide other image flavors that extend the features or minimize the image size to support a variety of use cases.

#### Minimal Flavor

<p>
<a href="https://hub.docker.com/r/khulnasoft/ml-station" title="Docker Image Version"><img src="https://img.shields.io/docker/v/khulnasoft/ml-station?color=blue&sort=semver"></a>
<a href="https://hub.docker.com/r/khulnasoft/ml-station-minimal" title="Docker Image Size"><img src="https://img.shields.io/docker/image-size/khulnasoft/ml-station-minimal?color=blue&sort=semver"></a>
<a href="https://hub.docker.com/r/khulnasoft/ml-station-minimal" title="Docker Pulls"><img src="https://img.shields.io/docker/pulls/khulnasoft/ml-station-minimal.svg"></a>
</p>

<details>
<summary>Details (click to expand...)</summary>

The minimal flavor (`khulnasoft/ml-station-minimal`) is our smallest image that contains most of the tools and features described in the [features section](#features) without most of the python libraries that are pre-installed in our main image. Any Python library or excluded tool can be installed manually during runtime by the user.

```bash
docker run -p 8080:8080 khulnasoft/ml-station-minimal:0.13.2
```
</details>
...
<p>
<a href="https://hub.docker.com/r/khulnasoft/ml-station-r" title="Docker Image Version"><img src="https://img.shields.io/docker/v/khulnasoft/ml-station-r?color=blue&sort=semver"></a>
<a href="https://hub.docker.com/r/khulnasoft/ml-station-r" title="Docker Image Size"><img src="https://img.shields.io/docker/image-size/khulnasoft/ml-station-r?color=blue&sort=semver"></a>
...
The R flavor (`khulnasoft/ml-station-r`) is based on our default workspace image and extends it with the R-interpreter, R-Jupyter kernel, RStudio server (access via `Open Tool -> RStudio`), and a variety of popular packages from the R ecosystem.

```bash
docker run -p 8080:8080 khulnasoft/ml-station-r:0.12.1
```
</details>
...
<p>
<a href="https://hub.docker.com/r/khulnasoft/ml-station-spark" title="Docker Image Version"><img src="https://img.shields.io/docker/v/khulnasoft/ml-station-spark?color=blue&sort=semver"></a>
<a href="https://hub.docker.com/r/khulnasoft/ml-station-spark" title="Docker Image Size"><img src="https://img.shields.io/docker/image-size/khulnasoft/ml-station-spark?color=blue&sort=semver"></a>
...
The Spark flavor (`khulnasoft/ml-station-spark`) is based on our R-flavor workspace image and extends it with the Spark runtime, Spark-Jupyter kernel, Zeppelin Notebook (access via `Open Tool -> Zeppelin`), PySpark, Hadoop, Java Kernel, and a few additional libraries & Jupyter extensions.

```bash
docker run -p 8080:8080 khulnasoft/ml-station-spark:0.12.1
```
...
<p>
<a href="https://hub.docker.com/r/khulnasoft/ml-station-gpu" title="Docker Image Version"><img src="https://img.shields.io/docker/v/khulnasoft/ml-station-gpu?color=blue&sort=semver"></a>
<a href="https://hub.docker.com/r/khulnasoft/ml-station-gpu" ttitle="Docker Image Size"><img src="https://img.shields.io/docker/image-size/khulnasoft/ml-station-gpu?color=blue&sort=semver"></a>
...
The GPU flavor (`khulnasoft/ml-station-gpu`) is based on our default workspace image and extends it with CUDA 10.1 and GPU-ready versions of various machine learning libraries (e.g., tensorflow, pytorch, cntk, jax). This GPU image has the following additional requirements for the system:
...
```bash
docker run -p 8080:8080 --gpus all khulnasoft/ml-station-gpu:0.13.2
```

- (Docker < 19.03) Nvidia Docker 2.0 ([📖 Instructions](https://github.com/NVIDIA/nvidia-docker/wiki/Installation-(version-2.0))).

```bash
docker run -p 8080:8080 --runtime nvidia --env NVIDIA_VISIBLE_DEVICES="all" khulnasoft/ml-station-gpu:0.13.2
```
...
The workspace is designed as a single-user development environment. For a multi-user setup, we recommend deploying [🧰 ML Hub](https://github.com/khulnasoft/ml-hub). ML Hub is based on JupyterHub with the task to spawn, manage, and proxy workspace instances for multiple users.
...
```bash
docker run -p 8080:8080 -v /var/run/docker.sock:/var/run/docker.sock khulnasoft/ml-hub:latest
```

For more information and documentation about ML Hub, please take a look at the [Github Site](https://github.com/khulnasoft/ml-hub).
...
| Type                     | Channel                                              |
| ------------------------ | ------------------------------------------------------ |
| 🚨&nbsp; **Bug Reports**       | <a href="https://github.com/khulnasoft/ml-station/issues?utf8=%E2%9C%93&q=is%3Aopen+is%3Aissue+label%3Abug+sort%3Areactions-%2B1-desc+" title="Open Bug Report"><img src="https://img.shields.io/github/issues/khulnasoft/ml-station/bug.svg"></a>                                  |
| 🎁&nbsp; **Feature Requests**  | <a href="https://github.com/khulnasoft/ml-station/issues?q=is%3Aopen+is%3Aissue+label%3Afeature+sort%3Areactions-%2B1-desc" title="Open Feature Request"><img src="https://img.shields.io/github/issues/khulnasoft/ml-station/feature.svg?label=feature%20request"></a>                                 |
| 👩‍💻&nbsp; **Usage Questions**   |  <a href="https://github.com/khulnasoft/ml-station/issues?q=is%3Aopen+is%3Aissue+label%3Asupport+sort%3Areactions-%2B1-desc" title="Open Support Request"> <img src="https://img.shields.io/github/issues/khulnasoft/ml-station/support.svg?label=support%20request"></a> <a href="https://stackoverflow.com/questions/tagged/khulnasoft" title="Open Question on Stackoverflow"> <img src="https://img.shields.io/badge/stackoverflow-ml--tooling-orange.svg"></a> <a href="https://gitter.im/khulnasoft/ml-station" title="Chat on Gitter"><img src="https://badges.gitter.im/khulnasoft/ml-station.svg"></a> |
| 📢&nbsp; **Announcements** | <a href="https://gitter.im/khulnasoft/ml-station" title="Chat on Gitter"><img src="https://badges.gitter.im/khulnasoft/ml-station.svg"></a> <a href="https://khulnasoft.substack.com/subscribe" title="Subscribe for updates"><img src="http://bit.ly/2Md9rxM"></a> <a href="https://twitter.com/khulnasoft" title="KhulnaSoft on Twitter"><img src="https://img.shields.io/twitter/follow/khulnasoft.svg?style=social&label=Follow"> |
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/open-tools.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/jupyter-tree.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/jupyter-notebook.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/desktop-vnc.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/desktop-vnc-clipboard.png"/>
...
<p align="center"><img src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/vs-code.png"/></p>
...
<p align="center"><img src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/vs-code-open.png"/></p>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/jupyterlab.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/git-open.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/git-ungit-credentials.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/git-push-notebook.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/git-nbdime-merging.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/git-jupytext.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/file-sharing-open.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/file-sharing-filebrowser.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/access-port.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/ssh-access.png"/>
...
You can find port information on all the tools in the [supervisor configuration](https://github.com/khulnasoft/ml-station/blob/main/resources/supervisor/supervisord.conf).
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/remote-dev-jupyter-kernel.png"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/remote-dev-vscode.gif"/>
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/tensorboard-open.png" />

If you have opened a Tensorboard instance in a valid log directory, you will see the visualizations of your logged data:

<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/tensorboard-dashboard.png" />
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/hardware-monitoring-netdata.png" />
...
<img style="width: 100%" src="https://github.com/khulnasoft/ml-station/raw/main/docs/images/features/hardware-monitoring-glances.png"/>
...
You can execute code directly from Git, Mercurial, Subversion, or Bazaar by using the pip-vcs format as described in [this guide](https://pip.pypa.io/en/stable/reference/pip_install/#vcs-support). For example, to execute code from a [subdirectory](https://github.com/khulnasoft/ml-station/tree/main/resources/tests/ml-job) of a git repository, just run:

```bash
docker run --env EXECUTE_CODE="git+https://github.com/khulnasoft/ml-station.git#subdirectory=resources/tests/ml-job" khulnasoft/ml-station:0.13.2
```
...
```bash
docker run -v "${PWD}:/workspace/ml-job/" --env EXECUTE_CODE="/workspace/ml-job/" khulnasoft/ml-station:0.13.2
```
...
```dockerfile
FROM khulnasoft/ml-station:0.13.2
...
> 📖 _For a more comprehensive Dockerfile example, take a look at the [Dockerfile of the R-flavor](https://github.com/khulnasoft/ml-station/blob/main/r-flavor/Dockerfile)._
...
docker run -d \
    ...
    --env AUTHENTICATE_VIA_JUPYTER="mytoken" \
    --restart always \
    khulnasoft/ml-station:0.8.7
```
and needs to be updated to version `0.9.1`, you need to:

1. Stop and remove the running workspace container: `docker stop "ml-station" && docker rm "ml-station"`
2. Start a new workspace container with the newer image and same configuration: `docker run -d -p 8080:8080 --name "ml-station" -v "/path/on/host:/workspace" --env AUTHENTICATE_VIA_JUPYTER="mytoken" --restart always khulnasoft/ml-station:0.9.1`
...
If you want to configure another language than English in your workspace and some tools are not translated properly, have a look <a href="https://github.com/khulnasoft/ml-station/issues/70#issuecomment-841863145">at this issue</a>. Try to comment out the 'exclude translations' line in `/etc/dpkg/dpkg.cfg.d/excludes` and re-install / configure the package.
</details>
...
```bash
docker run --shm-size=2G khulnasoft/ml-station:0.13.2
```
...
- Pull requests are encouraged and always welcome. Read our [contribution guidelines](https://github.com/khulnasoft/ml-station/tree/main/CONTRIBUTING.md) and check out [help-wanted](https://github.com/khulnasoft/ml-station/issues?utf8=%E2%9C%93&q=is%3Aopen+is%3Aissue+label%3A"help+wanted"+sort%3Areactions-%2B1-desc+) issues.
- Submit Github issues for any [feature request and enhancement](https://github.com/khulnasoft/ml-station/issues/new?assignees=&labels=feature&template=02_feature-request.md&title=), [bugs](https://github.com/khulnasoft/ml-station/issues/new?assignees=&labels=bug&template=01_bug-report.md&title=), or [documentation](https://github.com/khulnasoft/ml-station/issues/new?assignees=&labels=documentation&template=03_documentation.md&title=) problems.
- By participating in this project, you agree to abide by its [Code of Conduct](https://github.com/khulnasoft/ml-station/blob/main/.github/CODE_OF_CONDUCT.md).
...
Refer to our [contribution guides](https://github.com/khulnasoft/ml-station/blob/main/CONTRIBUTING.md#development-instructions) for more detailed information on our build scripts and development process.
